...
Shader "Projection/FisheyeProjection"
{
	Properties{
		...
		_k1("k1", Float) = -0.0876709			// k1-k3: fisheye lens distortion parameters(calculated by camera calibration using fisheye camera model)
		_k2("k2", Float) = 0.1010922
		_k3("k3", Float) = -0.1113332
		_k4("k4", Float) = 0.04654938
